...
#include "ui_goodskindmgr.h"
#include <QSqlQuery>
#include <QDebug>
#include <QMessageBox>


GoodsKindMgr::GoodsKindMgr(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::GoodsKindMgr)
{
    ui->setupUi(this);
...
GoodsKindMgr::~GoodsKindMgr()
{
    delete ui;
}

// init Data
void GoodsKindMgr::initData(){
...
bool GoodsKindMgr::eventFilter(QObject *obj, QEvent *event){
...
// Create new row
void GoodsKindMgr::on_btnCreate_clicked()
{
...
// Delete data
void GoodsKindMgr::on_btnDelete_clicked()
{
    deleteRow();
}

// Save data
void GoodsKindMgr::on_btnSave_clicked()
{
...
// Flush data
void GoodsKindMgr::on_btnFlush_clicked()
{
    initData();
}
